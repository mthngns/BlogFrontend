...
const BlogList = () => {
  ...
  const economyBlogs = blogs.filter((blog) => blog.category === "Economy");
  const cookingBlogs = blogs.filter((blog) => blog.category === "Cooking");
  const healthBlogs = blogs.filter((blog) => blog.category === "Health");
  const natureBlogs = blogs.filter((blog) => blog.category === "Nature");
  const fashionBlogs = blogs.filter((blog) => blog.category === "Fashion");
  const lifeBlogs = blogs.filter((blog) => blog.category === "Life");
  ...
  return (
    <div className="flex flex-col gap-y-10 w-5/6 text-slate-600 dark:text-slate-400 self-center pb-10 ">
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Technology Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {technologyBlogs.map((blog: Blog) => {
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Health Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {healthBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Nature Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {natureBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Life Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {lifeBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Cooking Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {cookingBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Travel Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {travelBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Economy Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {economyBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
      ...
      <div className="w-full border p-10">
        ...
        <p className="mb-3">Latest Fashion Blogs</p>
        <div className="flex gap-10 overflow-x-auto">
          {fashionBlogs.map((blog: Blog) => {
            const author = users.find((user) => user.id === blog.authorId);
            return <BlogCard key={blog.id} blogData={blog} author={author!} />;
          })}
        </div>
