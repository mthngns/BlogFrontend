...
const Account = () => {
    ...
    return (
        <div className='flex grow p-20 mt-10 dark:text-slate-400'>
            {!user && (
                <div>
            ...
            {user && (
                <div  className="flex gap-10 items-center w-full">
                    <div className='w-1/3 self-start p-5 h-full  border dark:border-slate-700 rounded-lg flex flex-col gap-y-10'>
                        ...
                        <div className='w-fit flex items-center gap-x-5 self-center'>
                            <div className='flex flex-col items-center border dark:border-slate-700 p-4 rounded-md'>
                    ...
                    <div className='w-2/3 self-start p-5 h-full  border dark:border-slate-700 rounded-lg flex flex-col gap-y-4'>
